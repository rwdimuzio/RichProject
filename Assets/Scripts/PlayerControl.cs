...
// update if we have gone too far, pull us back in
        ...
        if(transform.position.z < minZ)
            ...
            transform.position = new Vector3(
                transform.position.x + horizInput,
        ...
        if(Input.GetKeyDown(KeyCode.Space)){
            Instantiate(
                pewPrefab,
                new Vector3(gameObject.transform.position.x,gameObject.transform.position.y,gameObject.transform.position.z+2),
